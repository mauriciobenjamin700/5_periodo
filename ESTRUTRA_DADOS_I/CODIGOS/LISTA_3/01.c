...
int main(void)
{
    ...
    printf("\nDe acordo com pesquisas:\nnao deveria haver como calcular a area da esfera em um matrize zerada\nMas usando como base a area da matriz, poderia sim se desenhar uma esfera com area no centro da matriz, confome mostra abaixo: ");
